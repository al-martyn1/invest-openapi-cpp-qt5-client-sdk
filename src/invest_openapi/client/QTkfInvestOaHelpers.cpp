...
class QTkfInvestOaSerializerSettings {
public:
    ...
    static QTkfInvestOaSerializerSettings *getInstance(){
        if(instance == nullptr){
            instance = new QTkfInvestOaSerializerSettings();
        }
        return instance;
    }
private:
    explicit QTkfInvestOaSerializerSettings(){
        instance = this;
        dateTimeFormat.clear();
    }
    static QTkfInvestOaSerializerSettings *instance;
    QString dateTimeFormat;
};

QTkfInvestOaSerializerSettings * QTkfInvestOaSerializerSettings::instance = nullptr;
...
bool setDateTimeFormat(const QString& dateTimeFormat){
    ...
    if(dt.isValid()){
        success = true;
        QTkfInvestOaSerializerSettings::setDateTimeFormat(dateTimeFormat);
    }
    return success;
}
...
QString toStringValue(const QDateTime &value) {
    // ISO 8601
    return QTkfInvestOaSerializerSettings::getInstance()->getDateTimeFormat().isEmpty()? value.toString(Qt::ISODate):value.toString(QTkfInvestOaSerializerSettings::getInstance()->getDateTimeFormat());
}
...
QString toStringValue(const QTkfInvestOaObject &value) {
    return value.asJson();
}

QString toStringValue(const QTkfInvestOaEnum &value) {
    return value.asJson();
}

QString toStringValue(const QTkfInvestOaHttpFileElement &value) {
    return value.asJson();
}
...
QJsonValue toJsonValue(const QDateTime &value) {
    return QJsonValue(value.toString(QTkfInvestOaSerializerSettings::getInstance()->getDateTimeFormat().isEmpty()?value.toString(Qt::ISODate):value.toString(QTkfInvestOaSerializerSettings::getInstance()->getDateTimeFormat())));
}
...
QJsonValue toJsonValue(const QTkfInvestOaObject &value) {
    return value.asJsonObject();
}

QJsonValue toJsonValue(const QTkfInvestOaEnum &value) {
    return value.asJsonValue();
}

QJsonValue toJsonValue(const QTkfInvestOaHttpFileElement &value) {
    return value.asJsonValue();
}
...
bool fromStringValue(const QString &inStr, QDateTime &value) {
    if (inStr.isEmpty()) {
        ...
        auto dateTime = QTkfInvestOaSerializerSettings::getInstance()->getDateTimeFormat().isEmpty()?QDateTime::fromString(inStr, Qt::ISODate) :QDateTime::fromString(inStr, QTkfInvestOaSerializerSettings::getInstance()->getDateTimeFormat());
        if (dateTime.isValid()) {
...
bool fromStringValue(const QString &inStr, QTkfInvestOaObject &value)
{
    QJsonParseError err;
...
bool fromStringValue(const QString &inStr, QTkfInvestOaEnum &value) {
    value.fromJson(inStr);
    return true;
}

bool fromStringValue(const QString &inStr, QTkfInvestOaHttpFileElement &value) {
...
bool fromJsonValue(QDateTime &value, const QJsonValue &jval) {
    ...
    if (!jval.isUndefined() && !jval.isNull() && jval.isString()) {
        value = QTkfInvestOaSerializerSettings::getInstance()->getDateTimeFormat().isEmpty()?QDateTime::fromString(jval.toString(), Qt::ISODate): QDateTime::fromString(jval.toString(), QTkfInvestOaSerializerSettings::getInstance()->getDateTimeFormat());
        ok = value.isValid();
    } else {
        ok = false;
    }
...
bool fromJsonValue(QTkfInvestOaObject &value, const QJsonValue &jval) {
    bool ok = true;
    if (jval.isObject()) {
...
bool fromJsonValue(QTkfInvestOaEnum &value, const QJsonValue &jval) {
    value.fromJsonValue(jval);
    return true;
}

bool fromJsonValue(QTkfInvestOaHttpFileElement &value, const QJsonValue &jval) {
