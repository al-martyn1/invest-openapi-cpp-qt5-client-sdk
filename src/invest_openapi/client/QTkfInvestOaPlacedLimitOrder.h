...
/*
 * QTkfInvestOaPlacedLimitOrder.h
 *
 * 
 */

#ifndef QTkfInvestOaPlacedLimitOrder_H
#define QTkfInvestOaPlacedLimitOrder_H
...
class QTkfInvestOaPlacedLimitOrder : public QTkfInvestOaObject {
public:
    QTkfInvestOaPlacedLimitOrder();
    QTkfInvestOaPlacedLimitOrder(QString json);
    ~QTkfInvestOaPlacedLimitOrder() override;
...
Q_DECLARE_METATYPE(OpenAPI::QTkfInvestOaPlacedLimitOrder)

#endif // QTkfInvestOaPlacedLimitOrder_H
