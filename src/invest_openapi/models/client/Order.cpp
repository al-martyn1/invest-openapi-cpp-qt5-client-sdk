...
void Order::fromJson(QString jsonString) {
...
void Order::fromJsonObject(QJsonObject json) {
...
QJsonObject Order::asJsonObject() const {
    QJsonObject obj;
    if (m_order_id_isSet) {
...
void Order::setOrderId(const QString &order_id) {
    this->order_id = order_id;
    this->m_order_id_isSet = true;
}

bool Order::is_order_id_Set() const{
    return m_order_id_isSet;
}

bool Order::is_order_id_Valid() const{
    return m_order_id_isValid;
}

QString Order::getFigi() const {
    return figi;
}
void Order::setFigi(const QString &figi) {
    this->figi = figi;
    this->m_figi_isSet = true;
}

bool Order::is_figi_Set() const{
    return m_figi_isSet;
}

bool Order::is_figi_Valid() const{
    return m_figi_isValid;
}

OperationType Order::getOperation() const {
    return operation;
}
void Order::setOperation(const OperationType &operation) {
    this->operation = operation;
    this->m_operation_isSet = true;
}

bool Order::is_operation_Set() const{
    return m_operation_isSet;
}

bool Order::is_operation_Valid() const{
...
bool Order::is_status_Set() const{
    return m_status_isSet;
}

bool Order::is_status_Valid() const{
    return m_status_isValid;
}

qint32 Order::getRequestedLots() const {
    return requested_lots;
}
void Order::setRequestedLots(const qint32 &requested_lots) {
    this->requested_lots = requested_lots;
    this->m_requested_lots_isSet = true;
}

bool Order::is_requested_lots_Set() const{
    return m_requested_lots_isSet;
}

bool Order::is_requested_lots_Valid() const{
    return m_requested_lots_isValid;
}

qint32 Order::getExecutedLots() const {
    return executed_lots;
}
void Order::setExecutedLots(const qint32 &executed_lots) {
    this->executed_lots = executed_lots;
    this->m_executed_lots_isSet = true;
}

bool Order::is_executed_lots_Set() const{
    return m_executed_lots_isSet;
}

bool Order::is_executed_lots_Valid() const{
...
bool Order::is_type_Set() const{
    return m_type_isSet;
}

bool Order::is_type_Valid() const{
...
bool Order::is_price_Set() const{
    return m_price_isSet;
}

bool Order::is_price_Valid() const{
