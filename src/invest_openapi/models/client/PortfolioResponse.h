...
#ifndef PortfolioResponse_H
#define PortfolioResponse_H
...
class PortfolioResponse : public Object {
public:
    PortfolioResponse();
    PortfolioResponse(QString json);
    ...
    void setPayload(const Portfolio &payload);
...
Q_DECLARE_METATYPE(OpenAPI::PortfolioResponse)

#endif // PortfolioResponse_H
