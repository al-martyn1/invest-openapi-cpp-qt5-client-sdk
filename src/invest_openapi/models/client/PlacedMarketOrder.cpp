...
PlacedMarketOrder::PlacedMarketOrder(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

PlacedMarketOrder::PlacedMarketOrder() {
    this->initializeModel();
}

PlacedMarketOrder::~PlacedMarketOrder() {}

void PlacedMarketOrder::initializeModel() {
...
void PlacedMarketOrder::fromJson(QString jsonString) {
...
void PlacedMarketOrder::fromJsonObject(QJsonObject json) {
...
QString PlacedMarketOrder::asJson() const {
...
QJsonObject PlacedMarketOrder::asJsonObject() const {
    QJsonObject obj;
    if (m_order_id_isSet) {
...
QString PlacedMarketOrder::getOrderId() const {
    return order_id;
}
void PlacedMarketOrder::setOrderId(const QString &order_id) {
    this->order_id = order_id;
    this->m_order_id_isSet = true;
}

bool PlacedMarketOrder::is_order_id_Set() const{
    return m_order_id_isSet;
}

bool PlacedMarketOrder::is_order_id_Valid() const{
    return m_order_id_isValid;
}

OperationType PlacedMarketOrder::getOperation() const {
    return operation;
}
void PlacedMarketOrder::setOperation(const OperationType &operation) {
    this->operation = operation;
    this->m_operation_isSet = true;
}

bool PlacedMarketOrder::is_operation_Set() const{
    return m_operation_isSet;
}

bool PlacedMarketOrder::is_operation_Valid() const{
    return m_operation_isValid;
}

OrderStatus PlacedMarketOrder::getStatus() const {
    return status;
}
void PlacedMarketOrder::setStatus(const OrderStatus &status) {
    this->status = status;
    this->m_status_isSet = true;
}

bool PlacedMarketOrder::is_status_Set() const{
    return m_status_isSet;
}

bool PlacedMarketOrder::is_status_Valid() const{
    return m_status_isValid;
}

QString PlacedMarketOrder::getRejectReason() const {
    return reject_reason;
}
void PlacedMarketOrder::setRejectReason(const QString &reject_reason) {
    this->reject_reason = reject_reason;
    this->m_reject_reason_isSet = true;
}

bool PlacedMarketOrder::is_reject_reason_Set() const{
    return m_reject_reason_isSet;
}

bool PlacedMarketOrder::is_reject_reason_Valid() const{
    return m_reject_reason_isValid;
}

QString PlacedMarketOrder::getMessage() const {
    return message;
}
void PlacedMarketOrder::setMessage(const QString &message) {
    this->message = message;
    this->m_message_isSet = true;
}

bool PlacedMarketOrder::is_message_Set() const{
    return m_message_isSet;
}

bool PlacedMarketOrder::is_message_Valid() const{
    return m_message_isValid;
}

qint32 PlacedMarketOrder::getRequestedLots() const {
    return requested_lots;
}
void PlacedMarketOrder::setRequestedLots(const qint32 &requested_lots) {
    this->requested_lots = requested_lots;
    this->m_requested_lots_isSet = true;
}

bool PlacedMarketOrder::is_requested_lots_Set() const{
    return m_requested_lots_isSet;
}

bool PlacedMarketOrder::is_requested_lots_Valid() const{
    return m_requested_lots_isValid;
}

qint32 PlacedMarketOrder::getExecutedLots() const {
    return executed_lots;
}
void PlacedMarketOrder::setExecutedLots(const qint32 &executed_lots) {
    this->executed_lots = executed_lots;
    this->m_executed_lots_isSet = true;
}

bool PlacedMarketOrder::is_executed_lots_Set() const{
    return m_executed_lots_isSet;
}

bool PlacedMarketOrder::is_executed_lots_Valid() const{
    return m_executed_lots_isValid;
}

MoneyAmount PlacedMarketOrder::getCommission() const {
    return commission;
}
void PlacedMarketOrder::setCommission(const MoneyAmount &commission) {
    this->commission = commission;
    this->m_commission_isSet = true;
}

bool PlacedMarketOrder::is_commission_Set() const{
    return m_commission_isSet;
}

bool PlacedMarketOrder::is_commission_Valid() const{
    return m_commission_isValid;
}

bool PlacedMarketOrder::isSet() const {
...
bool PlacedMarketOrder::isValid() const {
