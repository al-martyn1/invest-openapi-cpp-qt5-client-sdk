...
#ifndef MarketOrderResponse_H
#define MarketOrderResponse_H
...
class MarketOrderResponse : public Object {
public:
    MarketOrderResponse();
    MarketOrderResponse(QString json);
    ~MarketOrderResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::MarketOrderResponse)

#endif // MarketOrderResponse_H
