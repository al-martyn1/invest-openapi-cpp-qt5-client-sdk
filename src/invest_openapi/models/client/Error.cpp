...
void Error::fromJson(QString jsonString) {
...
void Error::fromJsonObject(QJsonObject json) {
...
QJsonObject Error::asJsonObject() const {
    QJsonObject obj;
...
QString Error::getTrackingId() const {
    return tracking_id;
}
void Error::setTrackingId(const QString &tracking_id) {
    this->tracking_id = tracking_id;
    this->m_tracking_id_isSet = true;
}

bool Error::is_tracking_id_Set() const{
    return m_tracking_id_isSet;
}

bool Error::is_tracking_id_Valid() const{
    return m_tracking_id_isValid;
}

QString Error::getStatus() const {
    return status;
}
void Error::setStatus(const QString &status) {
    this->status = status;
    this->m_status_isSet = true;
}

bool Error::is_status_Set() const{
    return m_status_isSet;
}

bool Error::is_status_Valid() const{
    return m_status_isValid;
}

Error_payload Error::getPayload() const {
    return payload;
}
void Error::setPayload(const Error_payload &payload) {
    this->payload = payload;
    this->m_payload_isSet = true;
}

bool Error::is_payload_Set() const{
    return m_payload_isSet;
}

bool Error::is_payload_Valid() const{
