...
#ifndef CandlesResponse_H
#define CandlesResponse_H
...
class CandlesResponse : public Object {
public:
    CandlesResponse();
    CandlesResponse(QString json);
    ~CandlesResponse() override;
    ...
    Candles getPayload() const;
    void setPayload(const Candles &payload);
...
Q_DECLARE_METATYPE(OpenAPI::CandlesResponse)

#endif // CandlesResponse_H
