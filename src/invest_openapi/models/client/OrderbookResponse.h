...
class OrderbookResponse : public Object {
public:
    OrderbookResponse();
    OrderbookResponse(QString json);
    ...
    Orderbook getPayload() const;
    void setPayload(const Orderbook &payload);
...
Q_DECLARE_METATYPE(OpenAPI::OrderbookResponse)
