...
template <> inline QVector<QString> modelMakeSqlSchemaStringVector_SQLITE<CandleResolution>( const QString &nameOrPrefix, bool forInlining )
{
    ...
    IOA_MODEL_TO_STRINGS_MODEL_MAKE_SQL_SCHEMA_STRING_VECTOR_INLINING_ELSE()
        ...
        IOA_MODEL_TO_STRINGS_MODEL_MAKE_SQL_SCHEMA_STRING_VECTOR_RES_APPEND2( "INTERVAL_MIN"                    , "VARCHAR(8)" );
        IOA_MODEL_TO_STRINGS_MODEL_MAKE_SQL_SCHEMA_STRING_VECTOR_RES_APPEND2( "INTERVAL_MAX"                    , "VARCHAR(8)" );
        IOA_MODEL_TO_STRINGS_MODEL_MAKE_SQL_SCHEMA_STRING_VECTOR_RES_APPEND2( "INTERVAL_RECOMENDED_INCREMENT"   , "VARCHAR(8)" );
        IOA_MODEL_TO_STRINGS_MODEL_MAKE_SQL_SCHEMA_STRING_VECTOR_RES_APPEND2( "DESCRIPTION"                     , "VARCHAR(255)" );
    IOA_MODEL_TO_STRINGS_MODEL_MAKE_SQL_SCHEMA_STRING_VECTOR_INLINING_END()
...
//----------------------------------------------------------------------------
// INVALID_VALUE_OPENAPI_GENERATED, DONE, DECLINE, PROGRESS
template <> inline QVector<QString> modelMakeSqlSchemaStringVector_SQLITE<OperationStatus>( const QString &nameOrPrefix, bool forInlining )
{
    IOA_MODEL_TO_STRINGS_MODEL_MAKE_SQL_SCHEMA_STRING_VECTOR_PROLOG();
...
//----------------------------------------------------------------------------
// INVALID_VALUE_OPENAPI_GENERATED, BUY, BUYCARD, SELL, BROKERCOMMISSION, EXCHANGECOMMISSION, SERVICECOMMISSION, MARGINCOMMISSION, OTHERCOMMISSION, PAYIN, PAYOUT, TAX, TAXLUCRE, TAXDIVIDEND, TAXCOUPON, TAXBACK, REPAYMENT, PARTREPAYMENT, COUPON, DIVIDEND, SECURITYIN, SECURITYOUT
template <> inline QVector<QString> modelMakeSqlSchemaStringVector_SQLITE<OperationTypeWithCommission>( const QString &nameOrPrefix, bool forInlining )
{
    IOA_MODEL_TO_STRINGS_MODEL_MAKE_SQL_SCHEMA_STRING_VECTOR_PROLOG();

    IOA_MODEL_TO_STRINGS_MODEL_MAKE_SQL_SCHEMA_STRING_VECTOR_INLINING_BEGIN()
        IOA_MODEL_TO_STRINGS_MODEL_MAKE_SQL_SCHEMA_STRING_VECTOR_RES_APPEND2( "ID"         , "INTEGER REFERENCES ORDER_STATUS" );
        IOA_MODEL_TO_STRINGS_MODEL_MAKE_SQL_SCHEMA_STRING_VECTOR_RES_APPEND2( "TYPE"       , "VARCHAR(14) NOT NULL" );
    IOA_MODEL_TO_STRINGS_MODEL_MAKE_SQL_SCHEMA_STRING_VECTOR_INLINING_ELSE()
        IOA_MODEL_TO_STRINGS_MODEL_MAKE_SQL_SCHEMA_STRING_VECTOR_RES_APPEND2( "ID"         , "INTEGER PRIMARY KEY" );
        IOA_MODEL_TO_STRINGS_MODEL_MAKE_SQL_SCHEMA_STRING_VECTOR_RES_APPEND2( "TYPE"       , "VARCHAR(14) NOT NULL UNIQUE" );
        IOA_MODEL_TO_STRINGS_MODEL_MAKE_SQL_SCHEMA_STRING_VECTOR_RES_APPEND2( "DESCRIPTION", "VARCHAR(255)" );
    IOA_MODEL_TO_STRINGS_MODEL_MAKE_SQL_SCHEMA_STRING_VECTOR_INLINING_END()
