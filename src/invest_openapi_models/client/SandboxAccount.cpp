...
SandboxAccount::SandboxAccount(QString json) {
...
void SandboxAccount::initializeModel() {
...
void SandboxAccount::fromJson(QString jsonString) {
...
void SandboxAccount::fromJsonObject(QJsonObject json) {
...
QString SandboxAccount::asJson() const {
...
QJsonObject SandboxAccount::asJsonObject() const {
    QJsonObject obj;
...
BrokerAccountType SandboxAccount::getBrokerAccountType() const {
    return broker_account_type;
}
void SandboxAccount::setBrokerAccountType(const BrokerAccountType &broker_account_type) {
    this->broker_account_type = broker_account_type;
    this->m_broker_account_type_isSet = true;
}

bool SandboxAccount::is_broker_account_type_Set() const{
    return m_broker_account_type_isSet;
}

bool SandboxAccount::is_broker_account_type_Valid() const{
    return m_broker_account_type_isValid;
}

QString SandboxAccount::getBrokerAccountId() const {
    return broker_account_id;
}
void SandboxAccount::setBrokerAccountId(const QString &broker_account_id) {
    this->broker_account_id = broker_account_id;
    this->m_broker_account_id_isSet = true;
}

bool SandboxAccount::is_broker_account_id_Set() const{
    return m_broker_account_id_isSet;
}

bool SandboxAccount::is_broker_account_id_Valid() const{
    return m_broker_account_id_isValid;
}

bool SandboxAccount::isSet() const {
...
bool SandboxAccount::isValid() const {
