...
PlacedLimitOrder::PlacedLimitOrder(QString json) {
...
void PlacedLimitOrder::initializeModel() {
...
void PlacedLimitOrder::fromJson(QString jsonString) {
...
void PlacedLimitOrder::fromJsonObject(QJsonObject json) {
...
QString PlacedLimitOrder::asJson() const {
...
QJsonObject PlacedLimitOrder::asJsonObject() const {
    QJsonObject obj;
    if (m_order_id_isSet) {
...
QString PlacedLimitOrder::getOrderId() const {
    return order_id;
}
void PlacedLimitOrder::setOrderId(const QString &order_id) {
    this->order_id = order_id;
    this->m_order_id_isSet = true;
}

bool PlacedLimitOrder::is_order_id_Set() const{
    return m_order_id_isSet;
}

bool PlacedLimitOrder::is_order_id_Valid() const{
    return m_order_id_isValid;
}

OperationType PlacedLimitOrder::getOperation() const {
    return operation;
}
void PlacedLimitOrder::setOperation(const OperationType &operation) {
    this->operation = operation;
    this->m_operation_isSet = true;
}

bool PlacedLimitOrder::is_operation_Set() const{
    return m_operation_isSet;
}

bool PlacedLimitOrder::is_operation_Valid() const{
    return m_operation_isValid;
}

OrderStatus PlacedLimitOrder::getStatus() const {
    return status;
}
void PlacedLimitOrder::setStatus(const OrderStatus &status) {
    this->status = status;
    this->m_status_isSet = true;
}

bool PlacedLimitOrder::is_status_Set() const{
    return m_status_isSet;
}

bool PlacedLimitOrder::is_status_Valid() const{
    return m_status_isValid;
}

QString PlacedLimitOrder::getRejectReason() const {
    return reject_reason;
}
void PlacedLimitOrder::setRejectReason(const QString &reject_reason) {
    this->reject_reason = reject_reason;
    this->m_reject_reason_isSet = true;
}

bool PlacedLimitOrder::is_reject_reason_Set() const{
    return m_reject_reason_isSet;
}

bool PlacedLimitOrder::is_reject_reason_Valid() const{
    return m_reject_reason_isValid;
}

QString PlacedLimitOrder::getMessage() const {
    return message;
}
void PlacedLimitOrder::setMessage(const QString &message) {
    this->message = message;
    this->m_message_isSet = true;
}

bool PlacedLimitOrder::is_message_Set() const{
    return m_message_isSet;
}

bool PlacedLimitOrder::is_message_Valid() const{
    return m_message_isValid;
}

qint32 PlacedLimitOrder::getRequestedLots() const {
    return requested_lots;
}
void PlacedLimitOrder::setRequestedLots(const qint32 &requested_lots) {
    this->requested_lots = requested_lots;
    this->m_requested_lots_isSet = true;
}

bool PlacedLimitOrder::is_requested_lots_Set() const{
    return m_requested_lots_isSet;
}

bool PlacedLimitOrder::is_requested_lots_Valid() const{
    return m_requested_lots_isValid;
}

qint32 PlacedLimitOrder::getExecutedLots() const {
    return executed_lots;
}
void PlacedLimitOrder::setExecutedLots(const qint32 &executed_lots) {
    this->executed_lots = executed_lots;
    this->m_executed_lots_isSet = true;
}

bool PlacedLimitOrder::is_executed_lots_Set() const{
    return m_executed_lots_isSet;
}

bool PlacedLimitOrder::is_executed_lots_Valid() const{
    return m_executed_lots_isValid;
}

MoneyAmount PlacedLimitOrder::getCommission() const {
    return commission;
}
void PlacedLimitOrder::setCommission(const MoneyAmount &commission) {
    this->commission = commission;
    this->m_commission_isSet = true;
}

bool PlacedLimitOrder::is_commission_Set() const{
    return m_commission_isSet;
}

bool PlacedLimitOrder::is_commission_Valid() const{
    return m_commission_isValid;
}

bool PlacedLimitOrder::isSet() const {
...
bool PlacedLimitOrder::isValid() const {
