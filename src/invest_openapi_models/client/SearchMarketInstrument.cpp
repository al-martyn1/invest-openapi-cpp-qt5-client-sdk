...
SearchMarketInstrument::SearchMarketInstrument(QString json) {
...
void SearchMarketInstrument::initializeModel() {
...
void SearchMarketInstrument::fromJson(QString jsonString) {
...
void SearchMarketInstrument::fromJsonObject(QJsonObject json) {
...
QString SearchMarketInstrument::asJson() const {
...
QJsonObject SearchMarketInstrument::asJsonObject() const {
    QJsonObject obj;
    if (m_figi_isSet) {
...
QString SearchMarketInstrument::getFigi() const {
    return figi;
}
void SearchMarketInstrument::setFigi(const QString &figi) {
    this->figi = figi;
    this->m_figi_isSet = true;
}

bool SearchMarketInstrument::is_figi_Set() const{
    return m_figi_isSet;
}

bool SearchMarketInstrument::is_figi_Valid() const{
    return m_figi_isValid;
}

QString SearchMarketInstrument::getTicker() const {
    return ticker;
}
void SearchMarketInstrument::setTicker(const QString &ticker) {
    this->ticker = ticker;
    this->m_ticker_isSet = true;
}

bool SearchMarketInstrument::is_ticker_Set() const{
    return m_ticker_isSet;
}

bool SearchMarketInstrument::is_ticker_Valid() const{
    return m_ticker_isValid;
}

QString SearchMarketInstrument::getIsin() const {
    return isin;
}
void SearchMarketInstrument::setIsin(const QString &isin) {
    this->isin = isin;
    this->m_isin_isSet = true;
}

bool SearchMarketInstrument::is_isin_Set() const{
    return m_isin_isSet;
}

bool SearchMarketInstrument::is_isin_Valid() const{
...
bool SearchMarketInstrument::is_min_price_increment_Set() const{
    return m_min_price_increment_isSet;
}

bool SearchMarketInstrument::is_min_price_increment_Valid() const{
    return m_min_price_increment_isValid;
}

qint32 SearchMarketInstrument::getLot() const {
    return lot;
}
void SearchMarketInstrument::setLot(const qint32 &lot) {
    this->lot = lot;
    this->m_lot_isSet = true;
}

bool SearchMarketInstrument::is_lot_Set() const{
    return m_lot_isSet;
}

bool SearchMarketInstrument::is_lot_Valid() const{
    return m_lot_isValid;
}

Currency SearchMarketInstrument::getCurrency() const {
    return currency;
}
void SearchMarketInstrument::setCurrency(const Currency &currency) {
    this->currency = currency;
    this->m_currency_isSet = true;
}

bool SearchMarketInstrument::is_currency_Set() const{
    return m_currency_isSet;
}

bool SearchMarketInstrument::is_currency_Valid() const{
    return m_currency_isValid;
}

QString SearchMarketInstrument::getName() const {
    return name;
}
void SearchMarketInstrument::setName(const QString &name) {
    this->name = name;
    this->m_name_isSet = true;
}

bool SearchMarketInstrument::is_name_Set() const{
    return m_name_isSet;
}

bool SearchMarketInstrument::is_name_Valid() const{
    return m_name_isValid;
}

InstrumentType SearchMarketInstrument::getType() const {
    return type;
}
void SearchMarketInstrument::setType(const InstrumentType &type) {
    this->type = type;
    this->m_type_isSet = true;
}

bool SearchMarketInstrument::is_type_Set() const{
    return m_type_isSet;
}

bool SearchMarketInstrument::is_type_Valid() const{
    return m_type_isValid;
}

bool SearchMarketInstrument::isSet() const {
...
bool SearchMarketInstrument::isValid() const {
